...
{ this->mMaxMoves = inMaxMoves; position=0; }
...
static PyTypeObject PyRunnerSimulatorWrapper_Type = { PyVarObject_HEAD_INIT(NULL, 0)
                                    "RunnerC.Runner"   /* tp_name */
                                };
...
PyMODINIT_FUNC PyInit_RunnerC() {
    ...
    if (PyType_Ready(&PyRunnerSimulatorWrapper_Type) < 0) { return NULL; }
